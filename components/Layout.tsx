      ...
      <header className="sticky top-0 z-50 bg-surface-light/95 dark:bg-surface-dark/95 backdrop-blur-md border-b border-[#f4ebe7] dark:border-neutral-800 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex-1 flex items-center justify-center gap-4 max-w-2xl px-4">
            <button className="hidden lg:flex items-center gap-2 rounded-full bg-background-light dark:bg-neutral-800 py-2.5 px-5 shadow-sm ring-1 ring-inset ring-gray-100 dark:ring-neutral-700 transition hover:ring-primary">
              <span className="material-symbols-outlined text-primary text-[20px]">location_on</span>
              <span className="text-sm font-bold whitespace-nowrap">Jarinu – SP</span>
