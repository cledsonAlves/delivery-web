...
const StoreCard: React.FC<StoreCardProps> = ({ store }) => {
  return (
    <div className="flex min-w-[280px] sm:min-w-[320px] flex-col justify-between gap-4 rounded-3xl bg-surface-light dark:bg-surface-dark p-5 shadow-sm ring-1 ring-[#f4ebe7] dark:ring-neutral-800 transition-all hover:shadow-xl hover:-translate-y-1">
      <Link to={`/store/${store.id}`} className="text-current no-underline">
